...
class Fee():
    def __init__(self, master):
        ...
        self.master.geometry('1370x750+100+30')
        self.master.config(bg='#cacfd2')
        ...
        # ==================================================Entries=================================================
        self.var_1 = DoubleVar(Frame_1, value='50000')
        ...
        self.branch_entry = ttk.Combobox(Frame_1, values=(' ', 'CSE', 'IT','EC','ME','CE'),
                                         font=('arial', 14), width=19, textvariable=self.branch)
        self.branch_entry.grid(row=4, column=1, padx=15, pady=5)

        self.sem_entry = ttk.Combobox(Frame_1, values=(' ', 'FIRST', 'SECOND', 'THIRD','Fourth','Fifth','Sixth','Seventh','Eighth'), font=('arial', 14), width=19,
